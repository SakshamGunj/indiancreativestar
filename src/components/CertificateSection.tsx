...
export function CertificateSection() {
  return (
    <section className="section-padding bg-gradient-to-br from-creative-purple/20 to-creative-blue/20">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <Badge variant="outline" className="mb-2">Official Recognition</Badge>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Add creative credentials to your professional profile</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-6 w-6 text-green-500 mt-0.5 shrink-0" />
                <div>
                  ...
                  <p className="text-muted-foreground">Demonstrate your commitment to your craft</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-6 w-6 text-green-500 mt-0.5 shrink-0" />
                <div>
                  ...
                  <p className="text-muted-foreground">Share your achievement with friends and followers</p>
                </div>
              </li>
            </ul>
          ...
          <div className="creative-card p-8 relative overflow-hidden group hover:scale-105 transition-all duration-500">
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-creative-blue/30 rounded-full blur-3xl group-hover:bg-creative-blue/40 transition-all duration-500" />
            <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-creative-purple/30 rounded-full blur-3xl group-hover:bg-creative-purple/40 transition-all duration-500" />
            
            <div className="relative bg-black/40 backdrop-blur-sm border border-white/10 rounded-xl p-6 shadow-xl">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-xl font-bold border-b border-white/20 pb-1 mb-4">[Your Name]</p>
