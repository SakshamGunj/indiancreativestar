    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/20 to-blue-900/20 py-8 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-block p-4 bg-gradient-to-r from-white/10 to-white/5 rounded-2xl border border-white/20 backdrop-blur-sm">
            <p className="text-white/80 mb-4 text-lg">Quick Start with Google</p>
            <Button 
            ...
            <p className="text-white/50 text-sm mt-3">No password required • Instant access</p>
          </div>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Registration Form */}
          <Card className="glassmorphism border-white/10 backdrop-blur-sm">
            <CardHeader>
