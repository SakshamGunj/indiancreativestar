  ...
  if (showGoogleProfileCompletion && googleUserData) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/20 to-blue-900/20 flex items-center justify-center p-3 sm:p-4 relative overflow-hidden">
        ...
        <Card className="w-full max-w-md sm:max-w-lg glassmorphism border-white/20 backdrop-blur-sm relative z-10">
          <CardHeader className="pb-4 sm:pb-6">
            <CardTitle className="text-lg sm:text-xl text-white text-center">
              Complete Your Profile
            </CardTitle>
            <CardDescription className="text-white/60 text-center text-sm sm:text-base">
              Please provide the remaining information to get your artist ID card
            </CardDescription>
          </CardHeader>
              ...
              <form onSubmit={googleProfileForm.handleSubmit(handleGoogleProfileCompletion)} className="space-y-4 sm:space-y-6">
                      ...
                      {imagePreview ? (
                        <div className="space-y-3">
                          <img 
                            src={imagePreview} 
                            alt="Preview" 
                            className="w-20 h-20 sm:w-24 sm:h-24 object-cover rounded-full mx-auto border-4 border-white/20"
                          />
                        ...
                        <div className="space-y-3">
                          <Camera className="h-8 w-8 sm:h-12 sm:w-12 text-white/40 mx-auto" />
                ...
                >
                  {isUploading ? (
                    ...
                    <>
                      <span className="text-sm sm:text-base">Complete Profile & Get ID Card</span>
  ...
  if (showSuccessMessage) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/20 to-blue-900/20 flex items-center justify-center p-3 sm:p-4 relative overflow-hidden">
        ...
        <Card className="w-full max-w-sm sm:max-w-lg glassmorphism border-white/20 backdrop-blur-sm relative z-10">
          <CardContent className="p-6 sm:p-10 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/20 to-blue-900/20 py-4 sm:py-8 px-3 sm:px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-creative-purple via-creative-pink to-creative-blue bg-clip-text text-transparent">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-block p-4 sm:p-6 bg-gradient-to-r from-white/10 to-white/5 rounded-2xl border border-white/20 backdrop-blur-sm max-w-sm sm:max-w-md mx-auto">
            ...
            <p className="text-white/70 mb-3 sm:mb-4 text-sm sm:text-base">Sign in with Google and complete your profile to get your artist ID card</p>
            <Button 
        ...
        <div className="max-w-sm sm:max-w-md mx-auto">
          {/* Toggle Buttons */}
          <div className="flex bg-white/10 rounded-xl p-1 mb-4 sm:mb-6 backdrop-blur-sm">
            <button
              onClick={() => handleModeToggle(false)}
              className={`flex-1 py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-semibold transition-all duration-300 text-sm sm:text-base ${
                !isLoginMode 
          ...
          <Card className="glassmorphism border-white/20 backdrop-blur-sm">
            {!isLoginMode ? (
              ...
              <>
                <CardHeader className="pb-4 sm:pb-6">
                  <CardTitle className="text-lg sm:text-xl text-white flex items-center gap-2">
                    <User className="h-4 w-4 sm:h-5 sm:w-5 text-creative-blue" />
                    Create Account
                  </CardTitle>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea 
                                {...field} 
                                placeholder="Enter your complete address"
                                className="bg-white/5 border-white/20 text-white min-h-[70px] sm:min-h-[80px] text-sm sm:text-base"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                      ...
                      >
                        {isUploading ? (
                          <>
                            ...
                            <span className="text-sm sm:text-base">Uploading Image...</span>
                          </>
                        ) : isRegistering ? (
                          <>
                            <Loader2 className="mr-2 h-4 w-4 sm:h-5 sm:w-5 animate-spin" />
              ...
              <>
                <CardHeader className="pb-4 sm:pb-6">
                  <CardTitle className="text-lg sm:text-xl text-white flex items-center gap-2">
                    <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-creative-purple" />
                    Sign In
                  </CardTitle>
                  <CardDescription className="text-white/60 text-sm sm:text-base">
                ...
                <CardContent className="px-4 sm:px-6 pb-6">
                  <Form {...loginForm}>
                    <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-3 sm:space-y-4">
                      ...
                      <Button 
                        type="submit" 
                        className="w-full bg-gradient-to-r from-creative-purple to-creative-blue h-10 sm:h-12 text-base sm:text-lg font-semibold" 
