...
export function WorkDetails() {
  ...
  if (work.isPrivate && !isAuthenticated) {
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 grid-pattern">
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20 grid-pattern" style={dynamicStyle}>
      <SEO 
