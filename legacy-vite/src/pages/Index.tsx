                    ...
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
                        ...
                        <div>
                            ...
                            <p className="text-[8px] md:text-[10px] tracking-[0.2em] uppercase text-white/40 flex items-center gap-1">
                                Event Management <span className="text-blue-400">• Current Live</span>
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div className="flex flex-col gap-8 mt-10">
                                        <div className="space-y-6 text-lg tracking-wider font-playfair">
                                            ...
                                            <div className="pt-4 border-t border-white/10 space-y-3">
                                                <button
                                                    onClick={() => navigate('/indiancreativestar/v3')}
                                                    className="w-full text-left group relative overflow-hidden rounded-lg bg-gradient-to-r from-purple-900/50 to-purple-800/50 border border-purple-500/30 p-4 transition-all hover:bg-purple-900"
                                                >
                                                    <div className="relative z-10 flex items-center justify-between">
                                                        <div>
                                                            <span className="block text-[10px] uppercase tracking-widest text-purple-300 font-bold mb-1">Live Now</span>
                                                ...
                                                <button
                                                    onClick={() => navigate('/rangkala-award')}
                                                    className="w-full text-left group relative overflow-hidden rounded-lg bg-gradient-to-r from-orange-900/50 to-orange-800/50 border border-orange-500/30 p-4 transition-all hover:bg-orange-900"
                                                >
                                                    <div className="relative z-10 flex items-center justify-between">
                                                        <div>
                                                            <span className="block text-[10px] uppercase tracking-widest text-orange-300 font-bold mb-1">Live Now</span>
            ...
            < header ref={targetRef} className="relative z-10 min-h-[90vh] flex items-center justify-center px-4 md:px-6 overflow-hidden pt-12 md:pt-0" >
                <motion.div style={{ opacity, scale }} className="text-center space-y-8 max-w-5xl mx-auto relative z-20">
                    ...
                    >
                        ...
                        <span className="text-purple-300 text-xs md:text-sm tracking-[0.2em] font-bold uppercase">Current Live Events: ICS S3 & Rang Kala Award</span>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="flex flex-col md:flex-row justify-center items-stretch gap-4 md:gap-6 pt-6 flex-wrap"
                    >
                        {/* Rang Kala Award Button */}
                        <Button
                            onClick={() => navigate('/rangkala-award')}
                            className="bg-gradient-to-r from-orange-900 via-[#1A0A00] to-orange-900 text-white hover:text-orange-200 border border-orange-500/50 rounded-xl px-4 py-3 h-auto min-w-[280px] transition-all duration-300 relative overflow-visible group shadow-[0_0_20px_rgba(249,115,22,0.3)] hover:shadow-[0_0_30px_rgba(249,115,22,0.5)] flex-1 md:flex-none"
                        >
                            ...
                            <div className="relative z-10 flex items-center gap-4 text-left">
                                <img src="https://i.ibb.co/SDwFD23N/PHOTO-2025-10-27-20-05-20.webp" className="w-12 h-12 md:w-16 md:h-16 rounded-full border-2 border-orange-400/50 shadow-lg group-hover:scale-110 transition-transform duration-300 object-cover" alt="Rang Kala Logo" />
                                <div className="flex flex-col">
                                    <span className="text-orange-300 text-[10px] font-bold tracking-widest uppercase mb-0.5">National Level</span>
                                    <span className="font-playfair font-bold text-lg md:text-xl xl:text-2xl tracking-tight leading-none text-white">Rang Kala Award</span>
                                </div>
                            </div>
                        ...
                        <Button
                            onClick={() => navigate('/indiancreativestar/v3')}
                            className="bg-gradient-to-r from-purple-900 via-[#1A0B2E] to-purple-900 text-white hover:text-purple-200 border border-purple-500/50 rounded-xl px-4 py-3 h-auto min-w-[280px] transition-all duration-300 relative overflow-visible group shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] flex-1 md:flex-none"
                        >
                            <div className="absolute -top-2 left-3 bg-red-600 text-white text-[8px] font-bold px-3 py-[2px] rounded-sm flex items-center gap-1 animate-pulse border border-red-400/50 shadow-sm z-30 tracking-widest uppercase transform -skew-x-12">
                                <div className="w-1 h-1 bg-white rounded-full"></div> LIVE
                            </div>
                            ...
                            <div className="relative z-10 flex items-center gap-4 text-left">
                                <img src="https://i.ibb.co/qL29ZCrV/THE-Shakespeare-Poetry-Award-2025-2.webp" className="w-12 h-12 md:w-16 md:h-16 rounded-full border-2 border-purple-400/50 shadow-lg group-hover:scale-110 transition-transform duration-300 object-cover" alt="ICS Logo" />
                                <div className="flex flex-col">
                                    <span className="text-purple-300 text-[10px] font-bold tracking-widest uppercase mb-0.5">National Level</span>
                                    <span className="font-playfair font-bold text-lg md:text-xl xl:text-2xl tracking-tight leading-none text-white">ICS Season 3</span>
                                </div>
                            </div>
                        ...
                        <div className="space-y-10 order-2 lg:order-1">
                            <div className="space-y-6">
                                ...
                                <p className="text-xl text-white/60 leading-relaxed max-w-lg">
                                    The ultimate national art stage is back. Plus, explore our newly launched <strong>Rang Kala Award</strong>!
                                </p>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4 pt-4">
                                <Button
                                    onClick={() => navigate('/indiancreativestar/v3')}
                                    className="bg-white text-black hover:bg-purple-600 hover:text-white rounded-none px-6 py-6 text-lg font-playfair transition-all"
                                >
                                    Enter ICS Season 3
                                </Button>
                                <Button
                                    onClick={() => navigate('/rangkala-award')}
                                    className="bg-gradient-to-r from-orange-500 to-amber-500 text-white hover:from-orange-600 hover:to-amber-600 border border-orange-500 shadow-lg rounded-none px-6 py-6 text-lg font-playfair transition-all"
                                >
                                    Rang Kala Award
                                </Button>
                            </div>
